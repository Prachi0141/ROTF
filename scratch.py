...
while(True):
    ...
    cv2.circle(frame, (70, 46), 5, (0, 0, 255), -1)
    cv2.circle(frame, (444, 47), 5, (0, 0, 255), -1)
    cv2.circle(frame, (498, 363), 5, (0, 0, 255), -1)
    cv2.circle(frame, (22, 355), 5, (0, 0, 255), -1)

    pts1 = np.float32([[70, 46], [444, 47], [498, 363], [22, 355]])
